        ...
        <div className="w-full lg:w-[45%] flex flex-col">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              <div>
                <h5 className="font-black text-[10px] uppercase tracking-[0.2em] mb-2 text-gray-900">
                  STRAIGHT UP:
                </h5>
                <p className="text-gray-500 text-sm leading-relaxed font-medium">
                  {product.details ||
                    "Clean, vegan, and cruelty-free formula. Dermatologist tested for all skin types."}
                </p>
              </div>
              <div>
                <h5 className="font-black text-[10px] uppercase tracking-[0.2em] mb-2 text-gray-900">
